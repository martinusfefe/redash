var _excluded = ["className"],
  _excluded2 = ["disabled", "containerComponent", "containerProps", "children"];
...
import "./style.less";
export var DragHandle = sortableHandle(_ref => {
...
export var SortableContainerWrapper = sortableContainer(_ref2 => {
  var children = _ref2.children;
  return children;
});
export var SortableElement = sortableElement(_ref3 => {
  var children = _ref3.children;
  return children;
});
export function SortableContainer(_ref4) {
  ...
  if (disabled) {
    ...
    // @ts-expect-error
    wrapperProps.helperContainer = wrap(wrapperProps.helperContainer, helperContainer => isFunction(helperContainer) ? helperContainer(containerRef.current) : containerRef.current);
    ...
    wrapperProps.updateBeforeSortStart = wrap(wrapperProps.updateBeforeSortStart, function (updateBeforeSortStart) {
      setIsDragging(true);
    ...
    // @ts-expect-error
    wrapperProps.onSortStart = wrap(wrapperProps.onSortStart, function (onSortStart) {
    ...
    wrapperProps.onSortEnd = wrap(wrapperProps.onSortEnd, function (onSortEnd) {
      setIsDragging(false);
    ...
    containerProps.className = cx("sortable-container", {
      "sortable-container-dragging": isDragging
    }, containerProps.className);
    containerProps.ref = containerRef;
  }
  var ContainerComponent = containerComponent;
  return /*#__PURE__*/React.createElement(SortableContainerWrapper, wrapperProps, /*#__PURE__*/React.createElement(ContainerComponent, containerProps, children));
}
