...
export function ControlLabel(_ref) {
  ...
  if (layout === "vertical" && label) {
    ...
    }, /*#__PURE__*/React.createElement("label", labelProps, /*#__PURE__*/React.createElement(Typography.Text, {
      disabled: disabled
    }, label)), children);
  }
  if (layout === "horizontal" && label) {
    return /*#__PURE__*/React.createElement(Grid.Row, {
      ...
      disabled: disabled
    }, label))), /*#__PURE__*/React.createElement(Grid.Col, {
      span: 12
    }, children));
  }
  return children;
...
export default function withControlLabel(WrappedControl) {
  ...
  function ControlWrapper(_ref2) {
    ...
    return /*#__PURE__*/React.createElement(ControlLabel, {
      layout: layout,
      label: label,
      labelProps: labelProps,
      disabled: disabled
    }, /*#__PURE__*/React.createElement(WrappedControl, _extends({
