...
function getUniqueValues(chartData) {
    ...
    (0, lodash_1.each)(chartData, series => {
...
function PieColorsSettings({ options, data, onOptionsChange }) {
    const colors = (0, react_1.useMemo)(() => ({
        Automatic: null,
        // @ts-expect-error ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        ...ColorPalette_1.AllColorPalettes[options.color_scheme],
    }), [options.color_scheme]);
    const series = (0, react_1.useMemo)(() => (0, lodash_1.map)(getUniqueValues((0, getChartData_1.default)(data.rows, options)), value => ({
        key: value,
        // @ts-expect-error ts-migrate(2538) FIXME: Type 'unknown' cannot be used as an index type.
        color: (options.valuesOptions[value] || {}).color || null,
    })), [options, data]);
    const updateValuesOption = (0, react_1.useCallback)((key, prop, value) => {
        onOptionsChange({
            valuesOptions: {
                [key]: {
                    [prop]: value,
...
PieColorsSettings.propTypes = prop_types_1.EditorPropTypes;
