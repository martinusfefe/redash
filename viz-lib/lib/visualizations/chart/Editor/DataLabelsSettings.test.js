...
function mount(options, done) {
    ...
    return enzyme_1.default.mount(react_1.default.createElement(DataLabelsSettings_1.default, { visualizationName: "Test", data: { columns: [], rows: [] }, options: options, onOptionsChange: changedOptions => {
