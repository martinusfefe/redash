...
const initSunburst_1 = __importDefault(require("./initSunburst"));
require("./renderer.less");
function Renderer({ data }) {
    const [container, setContainer] = (0, react_1.useState)(null);
    const render = (0, react_1.useMemo)(() => (0, initSunburst_1.default)(data), [data]);
    (0, react_1.useEffect)(() => {
        if (container) {
            render(container);
    ...
    return react_1.default.createElement("div", { className: "sunburst-visualization-container", ref: setContainer });
}
