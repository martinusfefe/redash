...
function Editor(_ref) {
  ...
  return (
    ...
    React.createElement(Section, null, /*#__PURE__*/React.createElement(Input, {
      label: /*#__PURE__*/React.createElement(React.Fragment, null, "Number format", /*#__PURE__*/React.createElement(ContextHelp.NumberFormatSpecs, null)),
...
export default function initNumberColumn(column) {
  var format = createNumberFormatter(column.numberFormat, true);
