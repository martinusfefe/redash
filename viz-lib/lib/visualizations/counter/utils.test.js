    ...
    describe("getCounterData()", () => {
        describe('"Count rows" option is disabled', () => {
            test("No target and counter values return empty result", () => {
                const result = (0, utils_1.getCounterData)(dummy.rows, dummy.options, dummy.visualisationName);
            ...
            test('"Counter label" overrides vizualization name', () => {
                const result = (0, utils_1.getCounterData)(dummy.rows, { counterLabel: "Counter Label" }, dummy.visualisationName);
                expect(result).toEqual({
                    ...dummy.result,
            ...
            test('"Counter Value Column Name" must be set to a correct non empty value', () => {
                const result = (0, utils_1.getCounterData)(dummy.rows, { rowNumber: 3 }, dummy.visualisationName);
                expect(result).toEqual({
                    ...dummy.result,
                    showTrend: false,
                });
                const result2 = (0, utils_1.getCounterData)(dummy.rows, { counterColName: "missingColumn" }, dummy.visualisationName);
            ...
            test('"Counter Value Column Name" uses correct column', () => {
                const result = (0, utils_1.getCounterData)(dummy.rows, { counterColName: "population" }, dummy.visualisationName);
                expect(result).toEqual({
                    ...dummy.result,
            ...
            test("Counter and target values return correct result including trend", () => {
                const result = (0, utils_1.getCounterData)(dummy.rows, {
                    rowNumber: 1,
                ...
                const result2 = (0, utils_1.getCounterData)(dummy.rows, {
                    rowNumber: 2,
                    counterColName: "population",
                    targetRowNumber: 1,
                    targetColName: "population",
        ...
        describe('"Count rows" option is enabled', () => {
            ...
            test("Rows are counted correctly", () => {
                const result = (0, utils_1.getCounterData)(dummy.rows, { countRow: true }, dummy.visualisationName);
            ...
            test("Empty rows return counter value 0", () => {
                const result = (0, utils_1.getCounterData)([], { countRow: true }, dummy.visualisationName);
                expect(result).toEqual({
                    ...dummy.result,
                    counterValue: "0.000",
